...
`connection` с 25.09.2026 в `archive/`: подписки больше нет, практики — в бесплатном приложении.
...
| `connection` (в `archive/` с 25.09.2026, адрес ведёт на `/praktika#app`) | центрированный hero → «что внутри» (2 колонки: список + фото) → тарифы `.plan` ×3 → отзывы-карусель → футер |
