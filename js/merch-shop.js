/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ── ЕДИНСТВЕННОЕ, ЧТО ЗДЕСЬ МЕНЯЮТ ────────────────────────────────────────
   SHOP.live — переключатель боевого режима. Пока false, «оформить заказ»
   показывает, что ушло бы на сервер, и никуда не отправляет: сервис магазина
   ещё не подключён. Когда он появится — поставить true, и заработает
   и оплата картой, и заказ с оплатой при встрече.
   ═══════════════════════════════════════════════════════════════════════ */

var SHOP = {
  live: false,                       // ← true, когда сервис магазина включён
...
(function () {
  ...
  /* ═══ НАЛИЧИЕ ═══════════════════════════════════════════════════════ */
  /* когда сервис включён, витрина спрашивает у него остатки и гасит
     кнопку у того, что закончилось. страница при этом остаётся статикой */
